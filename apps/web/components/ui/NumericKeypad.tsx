    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%' }}>
      ...
      >
        {digits.map((digit) => (
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              boxShadow: '0 2px 6px rgba(51, 61, 41, 0.08)',
              display: 'flex',
              alignItems: 'center',
        ...
        <button
          ...
          title="Backspace"
        >
          <Delete size={26} strokeWidth={2.4} color="#F6F7F0" />
        </button>
      </div>
      ...
      >
        <XCircle size={18} color="#F6F7F0" /> Clear Entry (صاف کریں)
      </button>
    </div>
  );
};
